 <div data-scroll-to-active="true" class="main-menu menu-fixed menu-dark menu-accordion menu-shadow">
        ...
        <div class="main-menu-content">
          <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
            <li class=" nav-item"><a href="<?php echo ROOT_URL; ?>/dashboard/home"><i class="icon-home3"></i><span data-i18n="nav.dash.main" class="menu-title">Dashboard</span></a>
            ...
            <li class=" nav-item"><a href="#"><i class="icon-ios-albums-outline"></i><span data-i18n="nav.cards.main" class="menu-title">Assessments</span></a>
              <ul class="menu-content">
                ...
                <li><a href="<?php echo ROOT_URL; ?>/Assessment/add" data-i18n="nav.cards.card_bootstrap" class="menu-item">Add Assessment</a>
                </li>
