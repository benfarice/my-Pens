...
if(isset($_REQUEST['date_d_selected']) && isset($_REQUEST['date_f_selected'])){
	 ...
	 $query_select = "select sum(Poids_net) as Poids_net, Prix_unitaire,
		...
		cast(ad.Date_adjudication as date) between '$_REQUEST[date_d_selected]' and '$_REQUEST[date_f_selected]') my_table 
...
if(isset($_REQUEST['date_d_selected']) && isset($_REQUEST['date_f_selected'])){
	...
	where cast(ad.Date_adjudication as date) between '$_REQUEST[date_d_selected]' and '$_REQUEST[date_f_selected]'
