...
exit();
	...
	<div class="container-fluid text-right">			
			...
			<div class="row">
			<div class="col-md-12 col-sm-12 col-xs-12" id="div_get_especes">
	...
	<div id="myModal_delete_espece" class="modal fade" role="dialog">
	  <div class="modal-dialog modal-lg">
	    ...
	    <div class="modal-content">
	      <div class="modal-header">
	        ...
	        <!--<h4 class="modal-title  text-right"><?php //echo lang('delete'); ?></h4>-->
	        </div>
	        <div class="col-md-3 col-sm-3 col-xs-3">
	        </div>
	      </div>
	      <div class="modal-body text-right">
	        <p id="delete_question_espece"></p>
	        <p id="delete_question_espece_1"></p>
	        <p id="delete_question_espece_2"></p>
	        <p id="delete_question_espece_3"></p>
	        <input type="hidden" name="" id="deleted_code_espece">
	      </div>
	      <div class="modal-footer">
	      	...
	      	<div class="col-md-6 col-sm-6 col-xs-6">
	      		<button type="button" class="btn btn-danger btn-block" onclick="delete_confirm_espece();">
	...
	<div id="myModal_update_espece" class="modal fade" role="dialog">
	  <div class="modal-dialog modal-lg">
	    ...
	    <div class="modal-content">
	      <div class="modal-header">
	        <button type="button" class="close" data-dismiss="modal">&times;</button>
	        <!--<h4 class="modal-title text-center"><?php //echo lang('update'); ?></h4>-->
	      </div>
	      <div class="modal-body">
	      
	        <div class="input-group input-group-lg">
			 
			  <input type="text" class="form-control" id="update_name_ar_espece" aria-label="Large" aria-describedby="inputGroup-sizing-sm">
			</div>

			 <div class="input-group input-group-lg">
			  
			  <input type="text" class="form-control" id="update_name_en_espece"
			   aria-label="Large" aria-describedby="inputGroup-sizing-sm">
			</div>

			<div class="input-group">
			 
			  <textarea class="form-control" aria-label="With textarea" id="update_desc_espece"></textarea>
			</div>

	        <div class="input-group mb-3">
			  
			  <select class="custom-select"  id="select_family_update_espece">
			    <option selected value="A">Choose...</option>
	        ...
	        <input type="hidden" name="" id="code_espece_update">
	      </div>
	      <div class="modal-footer">
	        	<div class="col-md-6 col-sm-6 col-xs-6">
	      		<button type="button" class="btn btn-info btn-block" data-dismiss="modal">
	      	...
	      	<div class="col-md-6 col-sm-6 col-xs-6">
	      		<button type="button" class="btn btn-danger btn-block" onclick="update_confirm_espece();">
	...
	<div id="myModal_add_espece" class="modal fade" role="dialog">
	  <div class="modal-dialog modal-lg">
	    ...
	    <div class="modal-content">
	      <div class="modal-header">
	      	<div class="col-md-6 col-sm-6 col-xs-6">
	      	<h4 class="modal-title text-right"><?php echo lang('add_new_espece'); ?></h4>
	      	</div>
	      ...
	      <div class="modal-body">
	        ...
	        <div class="input-group input-group-lg">
			  ...
			  <input type="text" class="form-control" id="add_name_ar_espece" aria-label="Large" aria-describedby="inputGroup-sizing-sm" placeholder="<?php echo lang('new_espece_name_ar'); ?>">
			</div>

			 <div class="input-group input-group-lg">
			  
			  <input type="text" class="form-control" id="add_name_en_espece"
			   aria-label="Large" aria-describedby="inputGroup-sizing-sm" placeholder="Name in English">
			</div>

			<div class="input-group">
			 
			  <textarea class="form-control" aria-label="With textarea" id="add_desc_espece"
			  placeholder="<?php echo lang('new_espece_name_desc'); ?>"></textarea>
			</div>

	        <div class="input-group mb-3">
			  
			  <select class="custom-select"  id="select_family_add_espece">
			    <option selected value="A">Choose...</option>
			    <option value="1">One</option>
			    <option value="2">Two</option>
			    <option value="3">Three</option>
	      ...
	      <div class="modal-footer">
	      	...
	      	<div class="col-md-6 col-sm-6 col-xs-6">
	      		<button type="button" class="btn btn-primary btn-block" onclick="add_confirm_espece();">
	        	<?php echo lang('ok'); ?>
	        	</button>
	      	</div>
	      </div>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo $css ?>dataTables.bootstrap4.min.js">
	<link rel="stylesheet" type="text/css" href="<?php echo $css ?>gestion_especes.css">
	
	
	<script type="text/javascript" src="<?php echo $js ?>gestion_especes.js"></script>
	<style type="text/css">
		table thead th {
		    font-size: 18px;
		}
