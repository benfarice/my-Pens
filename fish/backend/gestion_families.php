	...
	<div class="container-fluid text-right">			
			<div class="row">
				<div class="col-md-12 col-sm-12 col-xs-12 text-center">
					<h1><?php echo lang('gestion_families');?>
			...
			<div class="row" id="search_menu">
				...
				<div class="col-md-4 col-sm-4 col-xs-4 text-center">
					<svg onclick="add_family_func();" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="85px" height="85px"
			...
			<div class="row">
			<div class="col-md-12 col-sm-12 col-xs-12" id="div_get_family">
			<!--  Ajax here -->
	...
	<div id="myModal_delete_family" class="modal fade" role="dialog">
	  <div class="modal-dialog modal-lg">
	    ...
	    <div class="modal-content">
	      ...
	      <div class="modal-body text-right text-danger">
	        <p id="delete_question_family"></p>
	      
	        <input type="hidden" name="" id="deleted_code_family">
	      </div>
	      <div class="modal-footer">
	      	...
	      	<div class="col-md-6 col-sm-6 col-xs-6">
	      		<button type="button" class="btn btn-danger btn-block" onclick="ajax_func_delete_family();">
	...
	<div id="myModal_update_family" class="modal fade" role="dialog">
	  <div class="modal-dialog modal-lg">
	    ...
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
	        ...
	        <div class="input-group input-group-lg">
			  ...
			  <input type="text" class="form-control" id="update_name_ar_family" aria-label="Large" aria-describedby="inputGroup-sizing-sm">
			</div>
	        ...
	        <input type="hidden" name="" id="code_family_update">
	      </div>
	      <div class="modal-footer">
	        	<div class="col-md-6 col-sm-6 col-xs-6">
	      		<button type="button" class="btn btn-info btn-block" data-dismiss="modal">
	      	...
	      	<div class="col-md-6 col-sm-6 col-xs-6">
	      		<button type="button" class="btn btn-danger btn-block" onclick="ajax_func_update_family();">
	...
	<div id="myModal_add_family" class="modal fade" role="dialog">
	  <div class="modal-dialog modal-lg">
	    ...
	    <div class="modal-content">
	      <div class="modal-header">
	      	<div class="col-md-6 col-sm-6 col-xs-6">
	      	<h4 class="modal-title text-right"><?php echo lang('add_new_family'); ?></h4>
	      	</div>
	      ...
	      <div class="modal-body">
	        ...
	        <div class="input-group input-group-lg">
			  ...
			  <input type="text"  class="form-control" id="add_name_ar_family" aria-label="Large" aria-describedby="inputGroup-sizing-sm" placeholder="<?php echo lang('new_family_name_ar'); ?>">
			</div>
	      ...
	      <div class="modal-footer">
	      	...
	      	<div class="col-md-6 col-sm-6 col-xs-6">
	      		<button type="submit" class="btn btn-primary btn-block" onclick="ajax_func_add_family();">
	        	<?php echo lang('ok'); ?>
	        	</button>
	      	</div>
	      </div>
	...
	<script type="text/javascript" src="<?php echo $js ?>gestion_families.js"></script>
	<style type="text/css">
		table thead th {
		    font-size: 18px;
		}
		#delete_question_family{
			font-size: 45px;
