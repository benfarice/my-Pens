...
function ajax_func_report_bill(){
            ...
            xmlhttp.open('GET','../Ajax/report_bill_sellers.php?date_d_selected='+date_d_selected+'&date_f_selected='+date_f_selected,true);
            xmlhttp.send();
        }
...
function print_f(){
            ...
            xmlhttp.open('GET','../Ajax/report_bill_sellers.php?print=yes&date_d_selected='+date_d_selected+'&date_f_selected='+date_f_selected,true);
            xmlhttp.send();
}
