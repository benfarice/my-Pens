...
// create new PDF document
  $obj_pdf = new MYPDF('P', PDF_UNIT, PDF_PAGE_FORMAT, true, 'UTF-8', false);  
		...
		$sql = "
		  SELECT r.CodeReg,(r.MtEspece+r.MtCheque+r.MtCredit )TotalPaye,r.MtEspece,r.MtCheque ,r.MtCredit ,r.DateReg,
 bye.ID_B_S CodeBye ,bye.name_ar NameAcht,fa.CodeFac,fa.Montant,fa.[Date] DateFac
   FROM reglements r 
   INNER JOIN detailReglements dr  ON dr.IdReg=r.IdReg
   INNER JOIN factures_acht fa  ON fa.CodeBye=r.CodeBuySel
   INNER JOIN BUYER_SELLER bye ON bye.ID_B_S=r.CodeBuySel AND bye.TYPE_B_S='BUYER' 
   where r.IdReg=? GROUP
BY r.CodeReg,(r.MtEspece+r.MtCheque ),r.MtCredit ,r.DateReg,fa.CodeFac,fa.Montant,fa.[Date],r.MtEspece,r.MtCheque ,
...
//arcourir($params);
			 ...
			 while($row=sqlsrv_fetch_array($resAff)){							 
								/*	  $Options.="<option value=".$row['IdType'].">". stripslashes (htmlentities($row['IdType']."  ".
									...
									//	echo "<br>---".$i."---<br>";
											...
											$groups[$key][$i]['DateFac']=$row['DateFac'];
		...
		//	 parcourir($groups);return;
						...
						$html0 ="";$TitleM="";$html1 ="";$html ="";$html2 ="";$MtCredit=0;$MtCheque=0;$MtEspece=0;
	...
	$CodeReg="";$CodeBye ="";$NameBye="";$DateReg=0;$NbrFac=0;$TotalReg=0;$TotalPaye=0;$Tax=0;$ValObll=0;$ValObllLettre="";
		$nRes = sqlsrv_num_rows($resAff);
	//	echo $nRes;
		...
		$MtEspece=$v['MtEspece'];$TotalPaye=$v['TotalPaye'];
					...
					$Reste=floatval($MtCheque)+floatval($MtEspece)-floatval($MtCredit);
		...
		foreach($v as $row){
				...
				$html2.='	
						<tr  height="40px" >
								...
								<td align="right"  > &nbsp;&nbsp;'. htmlentities($row['DateFac']).' </td>
		...
		$html1.='<table width="100%"  border="0" >
			...
			<td width="90%">
				<table WIDTh="100%"  border="0" align="center" >
					<tr> <td width="28%" align="right">أداء المشتري رقم </td>
						<TD width="33%">'.$CodeReg.'</td>
						<td width="38%" align="left">Payment Buyer Number	</td>
					</tr>
...
// This method has several options, check the source code documentation for more information.
		$name='paiement_pdf '.date('d-m-Y H-i').'.pdf';	
