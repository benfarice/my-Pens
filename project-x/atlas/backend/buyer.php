	...
	<input type="hidden" value='<?php echo $ID;?>' name="IdTable" />
		  <div class="row form-group">
			   <div class="col-md-6 col-sm-12 ">
			    ...
			    <div class="col-md-6 col-sm-12 ">
			    	<div class="row">
					<div class="col-md-12 text-right"><label><?php  echo lang('NomEn');?> :</label></div>
...
//$Code= "B".Increment_Chaine_F("ID_B_S","BUYER_SELLER","IdSelBuy",$con,"","");//$req,$array
//*************************************
$query_seller_code = "select count(*) as new_code from BUYER_SELLER s where s.TYPE_B_S = 'buyer'";
...
?>
	<form id="FormAdd" method="post" name="FormAdd">
		  ...
		  <div class="row">
			   <div class="col-md-6 col-sm-12 ">
			   			<div class="row form-group ">
						<div class="col-md-12 text-right"><label class=" control-label  labelRight"><?php  echo lang('NomAr');?> :</label></div>
			...
			<table class="table table-bordered table-condensed table-body-center" id="table1">
				...
				<?php while($row = sqlsrv_fetch_array($resAff, SQLSRV_FETCH_ASSOC)){
					...
					<tr>
						...
						<td data-title="">
						<a onclick="mod(<?php echo $row['IdSelBuy'];?>)" class="btn btn-primary btn-lg colorWhite"
						data-toggle="modal" >
...
$(document).ready(function() {
	$('#formRes').html('<center><br/><br/><?php echo lang('patienter');?> <br/><img src="layout/images/loading.gif" /></center>').load('buyer.php?aff');
});
function rechercher(){
