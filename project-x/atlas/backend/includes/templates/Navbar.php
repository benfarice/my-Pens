<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <a class="navbar-brand" href="#">
    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 47.518 47.518" style="enable-background:new 0 0 47.518 47.518;" xml:space="preserve" width="30px" height="30px">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="#home"><?php //echo lang('Accueil');?> <span class="sr-only">(current)</span></a>
      </li>
      -->
      <!--
      <li class="nav-item">
      ...
      <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          <?php echo lang('customize_Profile');?>
        </a>
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="gestion_families.php"><?php echo lang('gestion_families');?></a>
          <a class="dropdown-item" href="gestion_especes.php"><?php echo lang('gestion_especes');?></a>

          <div class="dropdown-divider"></div>
          <a class="dropdown-item" href="seller_buyer.php"><?php echo lang('SellerManage');?></a>
          <a class="dropdown-item" href="buyer.php"><?php echo lang('BuyerManage');?></a>
      ...
      <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          <?php echo lang('Compta');?>
        </a>
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="factures_acht.php"><?php echo lang('FactureAcht');?></a>
          <a class="dropdown-item" href="facture_vendeur.php"><?php echo lang('facture_vendeur');?></a>

          <div class="dropdown-divider"></div>
          <a class="dropdown-item" href="print_factures.php"><?php echo lang('print_facures');?></a>

          <div class="dropdown-divider"></div>
          <a class="dropdown-item" href="reglement_acht.php"><?php echo lang('reglement_acht');?></a>
          <a class="dropdown-item" href="reglement_vdr.php?sel"><?php echo lang('reglement_vdr');?></a>
        </div>
      </li>
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="identification_vdr.php"><?php echo lang('IdentificationVdr');?></a>
          <a class="dropdown-item" href="identification_esp.php"><?php echo lang('IdentificationEsp');?></a>

          <div class="dropdown-divider"></div>
          <a class="dropdown-item" href="report_bill_buyers.php"><?php echo lang('report_bill_buyers');?></a>
          <a class="dropdown-item" href="report_bill_sellers.php"><?php echo lang('report_bill_sellers');?></a>

          <div class="dropdown-divider"></div>
          <a class="dropdown-item" href="statistique_buy_sell_fish.php"><?php echo lang('statistic_sell_fish');?></a>
