				...
				<div class="col-md-8 col-sm-8 col-xs-8">
					<div class="row inner-background initial-menu">
						...
						<div class="col-md-12 col-sm-12 col-xs-12 text-center">
							<svg width="350px" height="180px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
						...
						<div class="col-md-6 col-sm-6 col-xs-6 menu_btn">
							<a href="report_buyers.php">
							<button class="btn btn-primary btn-block btn-lg categories_buttons">
								<?php echo lang('report_buyers');?>
							</button>
							</a>
						</div>
						<div class="col-md-6 col-sm-6 col-xs-6 menu_btn">
							<a href="report_sellers.php">
							<button class="btn btn-primary btn-block btn-lg categories_buttons">
								<?php echo lang('report_sellers');?>
							</button>
							</a>
						</div>
