<?php 
		...
		$pagetitle =  lang('report_sellers');
		$noNavbar = '';
		$report_sellers_fish_script = ''; 
		include 'init.php';
			...
			<div class="row outer-background">
				...
				<div class="col-md-12 col-sm-12 col-xs-12">
					...
					<div class="inner-background" id="input_poids">
						...
						<div class="col-md-4 col-sm-4 col-xs-4 radio_class" >
						    <div class="pretty p-default p-curve text-right">
						        <input type="radio" name="color" id="radio_lot_not_selled" />
						        <div class="state p-primary-o">
						            <label><?php echo lang('lot_not_selled'); ?></label>
						        </div>
						    </div>
						</div>
						<div class="col-md-4 col-sm-4 col-xs-4 radio_class">
						    <div class="pretty p-default p-curve text-right">
						        <input type="radio" name="color" id="radio_lot_is_selled" checked="checked" />
						        <div class="state p-success-o">
						            <label><?php echo lang('lot_has_selled'); ?></label>
						        </div>
						    </div>
						</div>
						<div class="col-md-4 col-sm-4 col-xs-4">
