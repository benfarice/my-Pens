...
$query_yesterday = "select TOP 1  a.id,(select c.nom from chauffeurs c where c.id = a.id_chauffeur)
...
from activite a
where a.etat = 2 and a.id_camion = ".$_REQUEST['id_vehicule'] ." order by a.id desc";
...
$stmt_query_yesterday=sqlsrv_query($con,$query_yesterday,$params_query_yesterday,$options_query_yesterday);
...
?>
									...
									<div class="row">
										<div class="col-md-12 col-sm-12 col-xs-12 t_background_today text-center">
											<h2>
												Activité : <?php echo date("d/m/Y", time() - 60 * 60 * 24); ?>
											</h2>
										</div>
