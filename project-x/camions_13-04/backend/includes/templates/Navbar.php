  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <a class="nav-link" href="gestion_camions.php">Home <span class="sr-only">(current)</span></a>
      </li>
      <!--
      <li class="nav-item">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="gestion_camions.php"><?php echo lang('gestion_camions');?></a>
          <a class="dropdown-item" href="gestion_chauf.php"><?php echo lang('gestion_chauf');?></a>
          <!--
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="etat_camion.php" ><?php echo lang('EtatCamion');?></a>
          <a class="dropdown-item" href="etat_chauf.php" ><?php echo lang('EtatChauf');?></a>
          <!--
          <div class="dropdown-divider"></div>
          <a class="dropdown-item" href="eta"><?php //echo lan('etat_actuel'); ?></a>
          -->
        </div>
      </li>
      <li class="nav-item">
