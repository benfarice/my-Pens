	...
	if($_SERVER['REQUEST_METHOD'] == 'POST'){
		...
		*/
		...
		if($count__Check_User > 0){
			...
			header('Location: gestion_camions.php');
...
?>
	...
	<head>
		...
		<link rel="stylesheet" type="text/css" href="<?php echo $css ?>menu_fr.css">
		    <link rel="stylesheet" href="<?php echo $css ?>ionicons.min.css" />
		<link rel="stylesheet" type="text/css" href="<?php echo $css ?>styles.css">
		<link rel="stylesheet" type="text/css" href="<?php echo $css ?>backend_fr.css">
