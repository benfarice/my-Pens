...
$newDateString1 = date_format(date_create_from_format('m/d/Y', $_REQUEST['first_date']), 'Y-m-d');
$newDateString2 = date_format(date_create_from_format('m/d/Y', $_REQUEST['second_date']), 'Y-m-d');
