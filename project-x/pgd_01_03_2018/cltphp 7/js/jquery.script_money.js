...
'       =2   Suisse 
'*********** 
' Conversion limite  999 999 999 999 999 ou 9 999 999 999 999,99 
' si le nombre contient plus de 2 dcimales, il est arrondit  2 dcimales 
*/
...
function ConvNumberLetter(Nombre, Devise, Langue) {
	...
	//alert('Nombre - dblEnt = '+ ceil(Nombre - dblEnt));
		
    byDec = parseInt(Math.ceil((Nombre - dblEnt) * 100)) ;
...
function ConvNumDizaine(Nombre, Langue) {
    ...
    if (byDiz == 8 && Langue != 2 && byUnit == 0) NumDizaine = NumDizaine + "" ;
    if (TabUnit[byUnit] != "") {
