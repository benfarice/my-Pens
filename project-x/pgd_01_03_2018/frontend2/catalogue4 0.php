...
<?php
 ...
 //echo $_SESSION['IdFamille']."___".$_SESSION['IdSousFam']."___".$_SESSION['IdMarque'] ; ?>
									...
									<DIV class="haut">
										...
										<form id="formAddArt<?php echo $i;?>" method="post" name="formAddArt"> 
											<TABLE   border="0" width="100%" class="table" cellspacing="2" cellpadding="7">
												<tr><TD width="25%">Référence:</td><td>	<?php  echo $r['Reference'];?>
												...
												<tr><TD>PV:</td><td><?php  echo $r['PV'];?></td></tr>
												<tr><TD>Colisage:</td><td height="70">
												<input type="radio" name="Colisage"  value="1" 
												data-labelauty="1<?php  echo $r['Unite'];?>|1<?php  echo $r['Unite'];?>" aria-label="2"  checked />
												<?php 
												if( $r['Colisage']!=1){
												?>
												<input type="radio" name="Colisage" value="<?php  echo $r['Colisage'];?>" 
												data-labelauty="<?php  echo $r['Colisage'];?><?php  echo $r['Unite'];?>s|
												<?php  echo $r['Colisage'];?><?php  echo $r['Unite'];?>"s aria-label="3"/>
												<?php }?>
												</td></tr>
												...
												<input type="button" value="Valider" class="btn"  onclick="AjoutArticle('<?php echo $i;?>')"/>&nbsp;&nbsp;
												<input type="button" value="Fermer"   style="display:none;"
												id="BtnFermer<?php echo $i;?>"
												class="btn"   onclick="AfficheGamme1('<?php echo $_SESSION['IdMarque'];?>','<?php echo $_GET['CurrentSlide'];?>')"/>
												</td>
												</tr>
											</table>
											</form> 
										...
										<div class="divRight">
										<img src="../<?php  echo $r['UrlArticle'];?>" alt=""  width=" 640" height="596" />	
										</div>
									</div>
															  </li>
...
if(!isset($_SESSION['lignesFam'])){
	...
	if($nRes==0)	{				
	$sql="select 
						a.IdArticle	,a.reference Reference ,CB codeABarre,colisagee Colisage,a.unite,a.TVA,
						me.url UrlArticle,
						fa.UrlFamille UrlFamille,
						fa.Designation DsgFamille,
						sf.Designation as dsgSousFamille,
		...
		and f.type='Groupe'
		group by 
		a.IdArticle	,a.reference,CB ,colisagee ,a.unite,a.TVA,
		me.url ,
						fa.Designation ,UrlFamille,
						sf.Designation ,UrlSousFamille,
						m.Designation,
...
$k=0;
	...
	foreach($_SESSION['lignesFam'] as $u=>$v){	
		...
		?>
		  <div class="cadreIndex hvr-grow"   style="width:250px; height:250px" onclick="AfficheSousFam('<?php echo $v['IdFamille'];?>')">
			<div  class="childIndex" style="width:250px; height:250px;max-width: 250px;" >
					<img src="../<?php echo $v['UrlFamille'];?>"  width="250" height="250"/>
								...
								?>
									<DIV class="haut">
										...
										<form id="formAddArt" method="post" name="formAddArt"> 
											<TABLE   border="0" width="100%" class="table" cellspacing="2" cellpadding="7">
												<tr><TD width="25%">Référence:</td><td>	<?php  echo $tabArtilce[0]['Reference'];?>
												<input type="hidden" value="<?php  echo $IdArticle; ?>" name="IdArticle">
												<input type="hidden" value="<?php  echo stripcslashes($dsgArticle); ?>" name="NomArt">
												<input type="hidden" value="<?php  echo stripcslashes($dsgGamme); ?>" name="Gamme">
												<input type="hidden" value="<?php  echo $TVA; ?>" name="TVA">
												...
												<tr><TD >Désignation: <?php echo $ColisageCmde;?></td><td>	<?php  echo stripcslashes(ucfirst($dsgArticle));?></td></tr>
												<tr><TD>Gamme:</td><td><?php  echo stripcslashes(ucfirst($dsgGamme));?></td></tr>
												<tr><TD>Sous famille:</td><td><?php  echo stripcslashes(ucfirst($DsgSousFam));?></td></tr>
												<tr><TD>Famille:</td><td><?php  echo stripcslashes(ucfirst($DsgFamille));?></td></tr>
												<tr><TD>PV:</td><td><?php  echo $tabArtilce[0]['PV'];?></td></tr>
												<tr><TD>Colisage:</td><td height="70">
...
<div class="divLeft">
		...
		<div class="divRight" style="width:640px">
...
$("#txtTotal").val("<?php echo number_format("0.00", 2, '.', ' '); ?>");
	$('#formRes').html('<center><br/><br/><img src="../images/loading2.gif" /></center>').load('catalogue4.php?affFam&&VideFam');
...
function AfficheGamme1(id,CurrentSlide){
					...
					var url='catalogue4.php?affGamme&&Id='+id;	}
					else {
							var url='catalogue4.php?affGamme&Id='+id+'&CurrentSlide='+CurrentSlide;	
					}
