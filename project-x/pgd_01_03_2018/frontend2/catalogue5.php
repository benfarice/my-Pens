...
<TABLE border="0" width="100%">
	<TR>	
												...
												class="btn btn-danger btn-lg animated fadeInLeft"   onclick="AfficheGamme1('<?php echo $_SESSION['IdFamille'];?>','<?php echo $_GET['CurrentSlide'];?>')"/>&nbsp;&nbsp;
												<input type="button" value="<?php  echo $trad['button']['Valider'];?>" class="btn btn-success btn-lg animated fadeInLeft"  onclick="AjoutArticle('<?php echo $i;?>')"/>
								...
								if($_SESSION['IdMarque']==$v["IdMarque"]){								
													...
													//echo count($f);return;
																...
																//	echo $r['DsgGamme'];;
																	...
																	<input type="button" class="DetailGamme animated fadeInUp" value="<?php  echo $trad['button']['VoirArticles'];?>  "  
...
//	parcourir($_SESSION['lignesFam']);return;
	foreach($_SESSION['lignesFam'] as $u=>$v){	
		...
		?>
		  <div class="cadreIndex hvr-grow animated fadeInUp"   style="width:285px;" onclick="rechercherFam('<?php echo $v['IdMarque'];?>')">
...
<DIV class="bottomVente animated fadeInLeft">
