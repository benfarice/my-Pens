...
<div  class="row row-centered ">
 ...
 <form id="formRechF" method="post" name="formRechF" > 
			...
			<div class="middleLabel "  ><label for="user_lastname"><?php echo $trad['label']['Periode'];?>: &nbsp;</label> </div>	 
			</div>
			...
			<div  class="  col-md-1 col-sm-12  centerLabel" > <label for="user_lastname"><?php echo $trad['label']['A'];?></label>	
			</div>
