...
$sql = "SELECT c.IdClient,c.nom,c.prenom,c.adresse,c.longitude,c.latitude,tc.Designation as Type ,v.Designation as Ville,a.DsgActivite ,a.icone  FROM clients c INNER JOIN villes v ON c.ville=v.idville INNER JOIN typeClients tc ON c.idTypeClient=tc.idType INNER JOIN  activites a ON c.IdActivite=a.IdActivite WHERE (c.longitude!='' and c.latitude!='') ". $whereVille ;//dc.idColisage *
//echo $sql;return;
$params = array();	
