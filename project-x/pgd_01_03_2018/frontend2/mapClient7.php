...
?>
<?php if(isset($_GET['GetImage'])){ //echo "here".$_GET['Chemin'] ; ?>
<div style="position: relative;">  
<input type="button" value=""  class="close2" onclick="retour()" Style="position: absolute;right:0px;"/>
...
<input type="button" value="" title="Voir image"  class="cam" onclick="OpenImage('<?php echo  $row["ImgMagasin"]; ?>')" Style="float:right;"/>
...
<tr>
<td align="left"><strong><u>Intitulé</u> :</strong></td>
<td><?php echo  $row["intitule"]; ?></td>
<td align="left"><strong><u>Adresse </u> :</strong></td>
...
//window.setTimeout( loadWindow, 15000 ); //15seconds
	...
	$('#formRes').html('<center><br/><br/>Merci de patienter pendant le chargement du map... <br/><img src="../images/loading2.gif" /><br/><a onClick="loadWindow()" href="#"><img src="img/rafraichir.png"/></a></center>');
