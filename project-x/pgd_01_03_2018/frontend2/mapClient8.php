...
<img src="<?php echo $_GET['Chemin'] ; ?>" alt="" width="1100" height="700"  />
</div>
...
<input type="button" value=""  class="close2" onclick="retour()" Style="position: absolute;<?php echo ($_SESSION['lang'] == 'ar' ) ? 'left' : 'right'; ?>:0px;"/>
	<span style="font-size:80px;vertical-align: middle;line-height: 660px;">
...
<table  width="88%" cellspacing="10" border="0" >
	<tr>
	...
	<tr>
		...
		<td align="<?php echo $_SESSION['align']; ?>"></td>
	</tr>
</table>
<?php
...
<div style="margin-bottom:5px;float:<?php echo ($_SESSION['lang'] == 'ar' ) ? 'left' : 'right'; ?>;margin-<?php echo ($_SESSION['lang'] == 'ar' ) ? 'left' : 'right'; ?>:50px;">
...
<div style="TEXT-align:<?php echo ($_SESSION['lang'] == 'ar' ) ? 'left' : 'right'; ?>;width:1030px;margin-top:5px;">
...
<?php } ?>
<input type="button" value="<?php echo $trad['map']['itineraire'] ; ?>" class="btn" onclick='calculateRoute(<?php echo $_GET['from'];?>,<?php echo $_GET['to'];?> )' />
</div>
<script language="javascript" type="text/javascript">
function Fermer(){
...
<div  onclick=" " >&nbsp;> <span  Class="TitleHead" ><?php echo $trad['index']['DemarreVisite'] ; ?></span></div></div>
...
//window.setTimeout( loadWindow, 15000 ); //15seconds
	...
	$('#formRes').html('<center><br/><br/><?php echo $trad['map']['messageChargementMap'] ; ?> <br/><img src="../images/loading2.gif" /><br/><a onClick="loadWindow()" href="#"><img src="img/rafraichir.png"/></a></center>');
//Si le chargement n\'aboutit pas , veuillez cliquer ici 
	//alert(ready);
	//-------getLocation();
	$('#formRes').load('mapClient.php?map');
					$('#boxClient').dialog({
					autoOpen		:	false,
					width			:	1100,
					height			:	700,
