...
'".$newDateString1."' and '".$newDateString2."' and f.idDepot <> 1";
...
f.Km,f.latitude,f.longitude,f.Montant,f.Operation,
f.SortieAutoroute,f.TypeFiltre,f.TypeVidange from frais f where f.DateOperation between
'".$newDateString1."' and '".$newDateString2."' and f.idDepot <> 1 and idDepot = ".$_REQUEST['inputdepot']." and IdVendeur = ".$_REQUEST['inputvendeur'];
...
*/
$query_depots ="select d.Designation from depots d where idDepot = $row[idDepot] and idDepot <> 1";
if($row['idDepot'] == null)
$query_depots ="select d.Designation from depots d where idDepot = 0";
//echo "<br>".$query_depots; 
$params_query_depots = array();
