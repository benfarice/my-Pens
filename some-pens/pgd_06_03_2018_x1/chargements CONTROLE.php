        ...
        <td  colspan="2">
			...
			<form id="formLigne" action="" method="post" name="<?php echo $ligne; ?>" >
				...
				<td width="110"  align="right">
					<input id="QteCh" action="QteCh" size="7" 
					col="<?php if( $row['Colisage']=="0") echo "1" ; else echo $row['Colisage']; ?>" 
				...
				//alert("QteCh "+QteCh);
					...
					/*$("input[name=QteDmdParPiece]").each(function(index) {
					 ...
					 QteTotlaDisp=QteDisp-QteHtml-parseFloat($("#QteDmdParPiece"+id).val());*/
						...
						//	alert("QteCh "+QteCh);
						if(QteCh > QteDisp){
						alert('La qantité chargée '+QteCh+' ne doit pas dépasser la quantité du stock : '+QteDisp);
						...
						$('table#table1 tr:last input[name=QteDisp]').val(QteCh);
...
<form id="formAdd" action="NULL" method="post" name="formAdd1"> 
		...
		<?php 
			...
			<input type="text" value="<?php //echo $donnees['Unite']; ?>"  name="Unite" id="Unite">
				</div>      
            </td>
     </tr>
          	<tr>
