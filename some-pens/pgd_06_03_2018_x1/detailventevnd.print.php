...
?>
		...
		<?php // Colisage -- Detaillant
			$keys=array($d,$trad['label']['typeDetaillant'],$designation,"Colisage");
			$result = extract_value($vente, $keys);
			$key=$gamme."col";
			if($result =="")
			{
		...
		<td>		
		<?php // Box -- Detaillant
			$keys=array($d,$trad['label']['typeDetaillant'],$designation,"Box");
			$result = extract_value($vente, $keys);
			$key=$gamme."box";
			if($result =="")
			{
		...
		<?php // Palette -- Detaillant
			$keys=array($d,$trad['label']['typeDetaillant'],$designation,"Palette");
			$result = extract_value($vente, $keys);
			$key=$gamme."pal";
			if($result =="")
			{
...
?>
		...
		<?php  // Colisage -- GROSSITE
			...
			$keys=array($d,$trad['label']['typeGrossite'],$designation,"Colisage");//print_r($keys);
			$result = extract_value($vente, $keys);
			$key=$gamme."col";
			if($result =="")
			{
		...
		<?php  // Box -- GROSSITE
			...
			$keys=array($d,$trad['label']['typeGrossite'],$designation,"Box");//print_r($keys);
			$result = extract_value($vente, $keys);
			$key=$gamme."box";
			if($result =="")
			{
		...
		<?php  // Palette -- GROSSITE
			...
			$keys=array($d,$trad['label']['typeGrossite'],$designation,"Palette");//print_r($keys);
			$result = extract_value($vente, $keys);
			$key=$gamme."pal";
			if($result =="")
			{
