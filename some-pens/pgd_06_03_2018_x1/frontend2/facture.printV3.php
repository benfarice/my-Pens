...
<div class="head">
	...
	<div class="HeadLeft">
	<h1>GLOBAL MANUFACTURERS ,Techno lab </h1><BR><BR>
	<img src="img/logo.png"  WIDTH="223" height="80"/><br><BR><BR>
	</div>
	<div class="HeadRight">
			<h1>Facture</h1><BR>
...
<SPAN style="font-size:11px; color:red;">Veuillez retourner ce bordereau avec votre paiement
	...
	<h1>GLOBAL MANUFACTURERS , Techno lab </h1><BR>
