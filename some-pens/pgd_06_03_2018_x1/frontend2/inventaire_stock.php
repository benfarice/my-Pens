...
$(document).ready(function () {
		var url='inventaire_stock.php?ConsultCmd';	
...
<div id="resReg"></div>
	...
	<script language="javascript" type="text/javascript">	
		...
		$('#formReg').ajaxSubmit({
							target:'#resReg',
							url:'inventaire_stock.php?TerminerCmd',
								method			:	'post'
							});
		patienter('resReg');
		}
...
function ConsultCmd(){
	 var Verif="";
	$.get("inventaire_stock.php?VerifSession", function(response) {
      Verif = response;
...
function getArticle(idArticle,list){
	if (list === undefined || list === null) {
		var url='inventaire_stock.php?getArticle&&idArticle='+idArticle;	
		$('#boxArticle').html('<center><br/><br/><img src="../images/loading2.gif" /></center>').load(url).dialog('open');
	}
	else{
		//pour afficher liste
		var url='inventaire_stock.php?getArticle&&list&&idArticle='+idArticle;	
		$('#boxArticle').html('<center><br/><br/><img src="../images/loading2.gif" /></center>').load(url).dialog('open');
	}
}
...
//$("#txtTotal").val("<?php echo number_format("0.00", 2, '.', ' '); ?>");
	//$('#formRes').html('<center><br/><br/><img src="../images/loading2.gif" /></center>').load('inventaire_stock.php?affGamme&&VideFam');
	$('#formRes').html('<center><br/><br/><img src="../images/loading2.gif" /></center>').load('inventaire_stock.php?affMarque&&VideFam');
		//$('#formRes').html('<center><br/><br/><img src="../images/loading2.gif" /></center>').load('inventaire_stock.php?TypeVente');
...
function AfficheGamme1(CurrentSlide){
					...
					var url='inventaire_stock.php?affGamme'	}
					else {
							var url='inventaire_stock.php?affGamme&CurrentSlide='+CurrentSlide;	
					}			
...
function AfficheGamme1(id,CurrentSlide){
					...
					if (CurrentSlide === undefined || CurrentSlide === null) {
					var url='inventaire_stock.php?affGamme&&Id='+id;	}
					else {
							var url='inventaire_stock.php?affGamme&Id='+id+'&CurrentSlide='+CurrentSlide;	
					}
...
function AfficheDetailGamme(id){
	//alert('lll');
	/*var url='inventaire_stock.php?aff&&Id='+id;	
	$('#box').html('<center><br/><br/><img src="../images/loading2.gif" /></center>').load(url).dialog('open');*/
	var current = slider.getCurrentSlide();
	var url='inventaire_stock.php?affArti&Id='+id+'&CurrentSlide='+current;	
	$('#formRes').html('<center><br/><br/><img src="../images/loading2.gif" /></center>').load(url);

}
function rechercherFam(id){
	
		var url='inventaire_stock.php?affFam&&Id='+id	;
		$('#formRes').html('<center><br/><br/><br/><br/><img src="../images/loading2.gif" /></center>').load(url);
}
function AfficheSousFam(id){
		//alert(id);
		var url='inventaire_stock.php?affSousFam&&Id='+id;	
		$('#formRes').html('<center><br/><br/><br/><br/><img src="../images/loading2.gif" /></center>').load(url);

	}
	function AfficheMarque(){
		var url='inventaire_stock.php?affMarque';	
		$('#formRes').html('<center><br/><br/><br/><br/><img src="../images/loading2.gif" /></center>').load(url);

	}
	/*
function AfficheMarque(id){
		var url='inventaire_stock.php?affMarque&&Id='+id;	
		$('#formRes').html('<center><br/><br/><br/><br/><img src="../images/loading2.gif" /></center>').load(url);
...
function FermerFenetre(){
	alert("fermer");
	var url='inventaire_stock.php?FermerFenetre';	
	//$("#box").load(url);
}
function ValideCmdEtape1(){
	/*$('#formCmd').ajaxSubmit({
		target:'#res',
		url:'inventaire_stock.php?ValideCmd',
			method			:	'post'
		});
		patienter('res');*/
...
$('#formRes').load('paiement.php?ChoixTypeReg');*/
		...
		//$('#box').dialog('close');
		$('#res').html('<center><br/><br/><br/><br/><img src="../images/loading2.gif" /></center>').load('inventaire_stock.php?TerminerCmd');
}
					...
					if(r)	{
							var Verif="";							 
							 // verification du stock vendeur pour l'article selectionné
							 	$(form).ajaxSubmit({
									   url : 'inventaire_stock.php?VerifStock',
									   type : 'POST',
									...
									//	alert(Verif);
											...
											$(form).ajaxSubmit({
																target			:	'#resAdd',
																url				:	'inventaire_stock.php?goAddArti',
																method			:	'post'
															});
															return false;
											}else 
...
function GetCatalogue(TypeVente){			 
	var url='inventaire_stock.php?affFam&&VideFam&&IdTypeVente='+TypeVente;
	$('#formRes').html('<center><br/><br/><img src="../images/loading2.gif" /></center>').load(url);
}
...
function RechArticle (){
		var Ref=$("#Ref").val();
		var url='inventaire_stock.php?getArticle&&Rech&&Ref='+Ref;	
		$('#boxArticle').html('<center><br/><br/><img src="../images/loading2.gif" /></center>').load(url).dialog('open');
		
		}
function  AffFormRech(){
	$('#boxRech').load("inventaire_stock.php?FormRech").dialog('open');
}	
</script>
