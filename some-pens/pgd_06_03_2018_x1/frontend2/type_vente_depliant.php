...
$(document).ready(function(){
		$('#formRes').html('<center><br/><br/><img src="../images/loading2.gif" /></center>').load('type_vente_depliant.php?TypeVente');
});
function GetCatalogue(IdTypeVente){			 
	var url='catalogue4.php?affFam&&VideFam&&IdTypeVente='+IdTypeVente;
			//$('#formRes').html('<center><br/><br/><img src="../images/loading2.gif" /></center>').load('catalogue4.php?GetIdTypeVente&&IdTypeVente='+IdTypeVente);
	window.location = 'depliant.php?IdTypeVente='+IdTypeVente;
