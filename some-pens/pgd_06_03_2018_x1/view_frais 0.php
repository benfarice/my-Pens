...
<script type="text/javascript">
			...
			$("#print_vidange_svg").click(function(){
                    ...
                    $("#table_vidange_print").html('<h1 class="text-center">Vidange <span>'+vidange_title+'</span></h1>' +
					 vidange_table);
			...
			$("#print_gasoil_svg").click(function(){
                    ...
                    $("#table_gasoil_print").html('<h1 class="text-center">Gasoil <span>'+vidange_title+'</span></h1>' +
					 vidange_table);
			...
			$("#print_Autoroute_svg").click(function(){
                    ...
                    $("#table_Autoroute_print").html('<h1 class="text-center">Autoroute <span>'+vidange_title+'</span></h1>' +
					 vidange_table);
			...
			$("#print_divers_svg").click(function(){
                    ...
                    $("#table_Divers_print").html('<h1 class="text-center">Divers <span>'+vidange_title+'</span></h1>' +
					 vidange_table);
